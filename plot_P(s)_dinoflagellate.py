...
resolution_microadriaticum  = 1000
resolution_minutum  = 5000

clr_microadriaticum = cooler.Cooler('/Users/lucasphilipp/Desktop/Research/GitHub/Dinoflagellate_Cholesteric_Large_Files/GSE152150_Dino-HiC-cD1plus-R1.smic1.1N.mapq_30.1000.mcool::resolutions/1000')

clr_minutum = cooler.Cooler('/Users/lucasphilipp/Desktop/Research/GitHub/Dinoflagellate_Cholesteric_Large_Files/GSM4658994_L142+L533+L534.inter_first_100_scaffolds.mcool::resolutions/5000')
...
pd.DataFrame(cvd_smooth_microadriaticum.values[:, [0,1,2,8]]).to_csv('/Users/lucasphilipp/Desktop/Research/GitHub/Dinoflagellate_Cholesteric_Large_Files/Ps_symbiodinium_microadriaticum_coccoid/GSE152150_Dino-HiC-cD1plus-R1.smic1.1N.mapq_30.1000.mcool_P(s).txt', sep='\t')
pd.DataFrame(cvd_smooth_minutum.values[:, [0,1,2,8]]).to_csv('/Users/lucasphilipp/Desktop/Research/GitHub/Dinoflagellate_Cholesteric_Large_Files/Ps_bminutum/GSM4658994_L142+L533+L534.inter.mcool_P(s).txt', sep='\t')
...
for region in df_microadriaticum['name']:
    ...
    ax.set_aspect(1.0)
    ax.grid(lw=0.5)
    plt.savefig("/Users/lucasphilipp/Desktop/Research/GitHub/Dinoflagellate_Cholesteric_Large_Files/Ps_symbiodinium_microadriaticum_coccoid/Plots_{0}".format(region))
    plt.show()
...
for region in df_minutum['name']:
    ...
    ax.set_aspect(1.0)
    ax.grid(lw=0.5)
    plt.savefig("/Users/lucasphilipp/Desktop/Research/GitHub/Dinoflagellate_Cholesteric_Large_Files/Ps_bminutum/Plots_{0}".format(region))
    plt.show()
